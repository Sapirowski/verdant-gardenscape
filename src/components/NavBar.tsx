    ...
    >
      <div className="container-custom flex justify-between items-center">
        <a href="#" className="flex items-center gap-2">
          <Leaf className={`h-7 w-7 ${isScrolled ? 'text-cerber-green-dark' : 'text-cerber-green-light'} animate-leaf-sway`} />
          <span className={`font-serif font-bold text-xl ${isScrolled ? 'text-cerber-green-dark' : 'text-white'}`}>
            Cerber Ogrodnictwo
          </span>
        </a>
